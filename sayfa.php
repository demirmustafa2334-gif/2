<?php
/**
 * Dinamik Sayfa İşleyicisi
 * Yerel Tanıtım - Özel PHP Scripti
 */

require_once 'config/config.php';

// URL'den sayfa slug'ını al
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <!-- Özel sayfalar için özel içerik -->
                <?php if ($slug === 'hizmetlerimiz'): ?>
                    <!-- Hizmetler Sayfası Özel İçerik -->
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                <div class="service-detail p-4 border rounded">
                                    ...
                                    <p>İstanbul'un tüm ilçe ve mahallelerini detaylı şekilde tanıtıyoruz.</p>
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-check text-success me-2"></i>Detaylı bölge rehberleri</li>
                                        <li><i class="fas fa-check text-success me-2"></i>Tarihi ve kültürel bilgiler</li>
                                        <li><i class="fas fa-check text-success me-2"></i>Güncel bölge haberleri</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="service-detail p-4 border rounded">
                                    ...
                                    <h4>Yerel İşletme Tanıtımı</h4>
                                    <p>Bölgenizdeki kaliteli işletmeleri keşfedin ve tanıyın.</p>
                                    <ul class="list-unstyled">
                                        <li><i class="fas fa-check text-success me-2"></i>İşletme rehberi</li>
                                        <li><i class="fas fa-check text-success me-2"></i>Müşteri yorumları</li>
                                        <li><i class="fas fa-check text-success me-2"></i>İletişim bilgileri</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <?php elseif ($slug === 'bolgelerimiz'): ?>
                    <!-- Bölgeler Sayfası Özel İçerik -->
                    <div class="regions-section mt-5">
                        <div class="row g-4">
                            <div class="col-md-4">
                                <div class="region-card text-center p-4 border rounded">
                                    <i class="fas fa-city fa-3x text-primary mb-3"></i>
                                    <h4>Avrupa Yakası</h4>
                                    <div class="region-count mb-3">
                                        <span class="h3 text-primary">25+</span>
                                        <p class="text-muted">İlçe</p>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li>Beyoğlu, Şişli, Beşiktaş</li>
                                        <li>Kadıköy, Üsküdar, Maltepe</li>
                            ...
                            <div class="col-md-4">
                                <div class="region-card text-center p-4 border rounded">
                                    ...
                                    <h4>Anadolu Yakası</h4>
                                    <div class="region-count mb-3">
                                        <span class="h3 text-success">14+</span>
                                        <p class="text-muted">İlçe</p>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li>Kadıköy, Üsküdar, Ataşehir</li>
                                        <li>Maltepe, Kartal, Pendik</li>
                                        <li>Ve daha fazlası...</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="region-card text-center p-4 border rounded">
                                    ...
                                    <h4>Adalar</h4>
                                    <div class="region-count mb-3">
                                        <span class="h3 text-info">9</span>
                                        <p class="text-muted">Ada</p>
                                    </div>
                                    <ul class="list-unstyled">
                                        <li>Büyükada, Heybeliada</li>
                                        <li>Burgazada, Kınalıada</li>
                                        <li>Ve diğer adalar...</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="text-center mt-4">
                            <a href="kesfet" class="btn btn-primary btn-lg">
                ...
                <?php elseif ($slug === 'yorumlar'): ?>
                    <!-- Yorumlar Sayfası Özel İçerik -->
                    <?php
                    $review = new Review();
                    ...
                    <div class="reviews-section mt-5">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted">
                                <?php echo $reviewStats['total_reviews']; ?> kullanıcı değerlendirmesi
                            </p>
                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <form id="contactForm" class="needs-validation" novalidate>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            <label for="from_district" class="form-label">İlçeniz</label>
                ...
                <div class="cta-section mt-5 p-4 bg-primary text-white rounded">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h4 class="mb-2">Daha Fazla Bilgi İçin!</h4>
                            <p class="mb-0">
                                Bölgeniz hakkında detaylı bilgi almak için bizimle iletişime geçin.
                            </p>
                        </div>
                        <div class="col-md-4 text-md-end">
                            <a href="kesfet" class="btn btn-warning btn-lg">
                                <i class="fas fa-search me-2"></i>
                                Keşfet
                            </a>
                        </div>
