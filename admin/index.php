            ...
            <div class="row mb-4">
                <div class="col-md-3 mb-3">
                    <div class="card bg-primary text-white">
                        ...
                        <div class="card-footer">
                            <a href="districts.php" class="text-white text-decoration-none">
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-success text-white">
                        ...
                        <div class="card-footer">
                            <a href="neighborhoods.php" class="text-white text-decoration-none">
                                <small>Detayları Görüntüle <i class="fas fa-arrow-right"></i></small>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-info text-white">
                        ...
                        <div class="card-footer">
                            <a href="reviews.php" class="text-white text-decoration-none">
                                <small>Detayları Görüntüle <i class="fas fa-arrow-right"></i></small>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-md-3 mb-3">
                    <div class="card bg-warning text-dark">
                        ...
                        <div class="card-footer">
                            <a href="messages.php" class="text-dark text-decoration-none">
                                <small>Detayları Görüntüle <i class="fas fa-arrow-right"></i></small>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php else: ?>
                                ...
                                <?php endforeach; ?>
                                <div class="text-center mt-3">
                                    <a href="reviews.php" class="btn btn-outline-primary btn-sm">
